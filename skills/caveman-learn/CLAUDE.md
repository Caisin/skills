...
## Layout
- `GUIDE.md` — the canonical skill body (frontmatter `name: caveman-learn` + a
...
into a repo's `.claude/skills/caveman-learn/GUIDE.md` (Claude Code) or
`~/.codex/skills/caveman-learn/GUIDE.md` (Codex). The CLI **embeds a byte-identical copy**
...
See ../../mem/CLAUDE.md (cavemem) · ../caveman-explore/GUIDE.md (the packaging precedent)
